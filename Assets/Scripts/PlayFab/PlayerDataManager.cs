...
public class PlayerDataManager : MonoBehaviour
{
    ...
    public void GuardarDatos(
        ...
        UserDataVisibility visibility = UserDataVisibility.Private,
    ...
    public void GuardarDato(
        string clave, 
        string valor,
        UserDataVisibility visibilidad = UserDataVisibility.Private,
        Action<string> callback = null,
        Action<string> onError = null)
    {
        GuardarDatos(new Dictionary<string, string> { { clave, valor } }, visibilidad, callback, onError);
    }
